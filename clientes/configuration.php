...
class gatorconf {
	...
	public static function get($param) {
		...
		$config = array(
				...
				// notation: 'r' - read only, 'ru' - read & upload, 'rwu' - read, write & upload
				'default_permissions_after_activation' => 'r',
				
				// email configuration
				'mail_from' => 'clientes@springair.com.mx',
				'mail_from_name' => 'clientes',
				'mail_signature' => "\n\n Saludos,\nSpring Air Mexico",
				...
				'account_email_subject' => 'Sistema de Clientes Spring Air Mexico',
